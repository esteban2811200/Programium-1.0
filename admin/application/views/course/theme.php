             ...
             <div class="row">
                 <div class="col-12">
                     <div class="card">
                         <!-- /.card-header -->
                         <div class="card-body">
                             <table id="tblThemes" class="table table-bordered table-striped">
                                 <thead>
                                     <tr>
                                         <th>Id</th>
                                         <th>Nombre</th>
 ...
 <script>
     ...
     const cancel = function(id) {
         return new Promise((resolve, reject) => {
             $.ajax({
                 url: '<?= base_url('course/deletetheme') ?>',
                 method: 'post',
                 type: 'json',
                 data: {
                     id: id
     ...
     const active = function(id) {
         return new Promise((resolve, reject) => {
             $.ajax({
                 url: '<?= base_url('course/activetheme') ?>',
                 method: 'post',
                 type: 'json',
                 data: {
                     id: id
     ...
     const getTheme = function(id) {
         return new Promise((resolve, reject) => {
             $.ajax({
                 url: '<?= base_url('course/findtheme') ?>',
                 method: 'post',
                 type: 'json',
                 data: {
                     id: id
